...
public class TaxInvoiceController
{
	...
	@ResponseBody
	@ApiOperation(nickname = "getTaxInvoiceRecipientTypes", value = "Gets tax invoice recipient types.", notes = "Returns recipient types for tax invoice.")
	@ApiBaseSiteIdParam
	...
	@ApiOperation(nickname = "removeCartTaxInvoice", value = "Deletes tax invoice from the cart.", notes = "Deletes tax invoice from the cart.")
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiOperation(nickname = "replaceCartTaxInvoice", value = "Updates tax invoice for the cart.", notes = "Updates tax invoice for the cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
