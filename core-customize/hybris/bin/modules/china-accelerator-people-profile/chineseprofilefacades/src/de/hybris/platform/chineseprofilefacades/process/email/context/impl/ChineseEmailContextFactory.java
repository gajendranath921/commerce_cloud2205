...
public class ChineseEmailContextFactory extends DefaultEmailContextFactory
{
			...
			final Map<String, Object> componentContext)
	{
		for (final String property : getCmsComponentService().getReadableEditorProperties(component))
		{
			try
			{
				final Object value = getValue(locale, component, componentContext, property);
	...
	private Object getValue(final Locale locale, final AbstractCMSComponentModel component,
			final Map<String, Object> componentContext, final String property)
	{
		Object value;
		if (component instanceof CMSImageComponentModel && MEDIA.equals(property))
		{
			...
			return getModelService().getAttributeValue(component, property, emailLanguageLocale);
