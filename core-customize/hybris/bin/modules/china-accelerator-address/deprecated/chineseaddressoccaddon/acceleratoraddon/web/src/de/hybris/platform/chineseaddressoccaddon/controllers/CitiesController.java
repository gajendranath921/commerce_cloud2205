...
public class CitiesController
{
	...
	@ApiOperation(nickname = "getCities", value = "Gets cities for a region.", notes = "Gets cities for a region.")
	@ApiBaseSiteIdParam
	...
	@ApiOperation(nickname = "getDistricts", value = "Gets districts for a city.", notes = "Gets districts for a city.")
	@ApiBaseSiteIdParam
