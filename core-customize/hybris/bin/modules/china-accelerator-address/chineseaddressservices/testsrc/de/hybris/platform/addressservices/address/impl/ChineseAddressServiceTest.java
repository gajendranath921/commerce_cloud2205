...
public class ChineseAddressServiceTest
{
	...
	{
		given(chineseAddressDao.getCitiesForRegion(any())).willReturn(Collections.emptyList());
	...
	public void testGetCitiesForRegion()
	{
		...
		cities.add(city);
		Mockito.doReturn(cities).when(chineseAddressDao).getCitiesForRegion(any());
	...
	{
		given(chineseAddressDao.getDistrictsForCity(any())).willReturn(Collections.emptyList());
	...
	public void testGetDistrictsForCity()
	{
		...
		Mockito.doReturn(districts).when(chineseAddressDao).getDistrictsForCity(any());
	...
	{
		Mockito.doReturn(city).when(chineseAddressDao).getCityForIsocode(any());
	...
	{
		Mockito.doReturn(district).when(chineseAddressDao).getDistrictForIsocode(any());
