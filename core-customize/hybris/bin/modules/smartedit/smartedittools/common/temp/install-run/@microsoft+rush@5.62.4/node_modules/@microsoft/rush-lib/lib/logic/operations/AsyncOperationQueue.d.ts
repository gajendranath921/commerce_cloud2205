 ...
 */
export declare class AsyncOperationQueue implements AsyncIterable<Operation>, AsyncIterator<Operation> {
     ...
     */
    constructor(opeartions: Iterable<Operation>, sortFn: IOperationSortFunction);
    /**
     * For use with `for await (const operation of taskQueue)`
     * @see {AsyncIterator}
     */
    next(): Promise<IteratorResult<Operation>>;
    /**
     ...
     */
    [Symbol.asyncIterator](): AsyncIterator<Operation>;
}
