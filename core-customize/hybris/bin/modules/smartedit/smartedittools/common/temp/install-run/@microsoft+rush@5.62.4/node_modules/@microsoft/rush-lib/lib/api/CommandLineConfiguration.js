...
class CommandLineConfiguration {
    ...
    constructor(commandLineJson, options = {}) {
        ...
        if (commandLineJson === null || commandLineJson === void 0 ? void 0 : commandLineJson.phases) {
            ...
            for (const phase of commandLineJson.phases) {
                ...
                const processedPhase = Object.assign(Object.assign({}, phase), { isSynthetic: false, logFilenameIdentifier: this._normalizeNameForLogFilenameIdentifiers(phase.name), associatedParameters: new Set(), index: -1, phaseDependencies: {
                        self: new Set(),
                        upstream: new Set()
                    } });
        ...
        for (const phase of this.phases.values()) {
            const selfDependencies = (_a = phase.dependencies) === null || _a === void 0 ? void 0 : _a.self;
            const upstreamDependencies = (_b = phase.dependencies) === null || _b === void 0 ? void 0 : _b.upstream;
            if (selfDependencies) {
            ...
            for (const command of commandLineJson.commands) {
                ...
                switch (command.commandKind) {
                    case RushConstants_1.RushConstants.phasedCommandKind: {
                        ...
                        normalizedCommand = Object.assign(Object.assign({}, command), { isSynthetic: false, associatedParameters: new Set(), phases: commandPhases, watchPhases, alwaysWatch: false });
        ...
        if (!options.doNotIncludeDefaultBuildCommands) {
            ...
            if (!this.commands.has(RushConstants_1.RushConstants.rebuildCommandName)) {
                ...
                const rebuildCommand = Object.assign(Object.assign({}, DEFAULT_REBUILD_COMMAND_JSON), { commandKind: RushConstants_1.RushConstants.phasedCommandKind, isSynthetic: true, phases: buildCommandPhases, disableBuildCache: DEFAULT_REBUILD_COMMAND_JSON.disableBuildCache, associatedParameters: buildCommand.associatedParameters, watchPhases: new Set(), alwaysWatch: false });
    ...
    _translateBulkCommandToPhasedCommand(command) {
        ...
        const translatedCommand = Object.assign(Object.assign({}, command), { commandKind: 'phased', isSynthetic: true, associatedParameters: new Set(), phases, 
            ...
            watchPhases: command.watchForChanges ? phases : new Set(), alwaysWatch: !!command.watchForChanges });
