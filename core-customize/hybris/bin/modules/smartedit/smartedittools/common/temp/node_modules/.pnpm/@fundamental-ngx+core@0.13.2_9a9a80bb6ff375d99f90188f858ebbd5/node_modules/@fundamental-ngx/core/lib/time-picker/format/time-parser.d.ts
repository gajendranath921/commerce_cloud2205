...
export declare class TimeFormatParserDefault extends TimeFormatParser {
     ...
     * @param displayMinutes boolean to define if string should display minutes.
     */
    parse(value: string, displaySeconds?: boolean, displayMinutes?: boolean, meridian?: boolean): TimeObject;
    /**
     ...
     * @param displayMinutes boolean to define if string should display minutes.
     */
    format(time: TimeObject, displaySeconds?: boolean, displayMinutes?: boolean, meridian?: boolean): string;
}
