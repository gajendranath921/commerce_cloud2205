...
export declare class DatePickerComponent implements ControlValueAccessor, Validator {
    ...
    /** @hidden */
    constructor(dateAdapter: DateFormatParser, _changeDetectionRef: ChangeDetectorRef, _datePipe: DatePipe);
    /**
     * @hidden
