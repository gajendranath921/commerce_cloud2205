...
export declare class DynamicComponentService {
     ...
     */
    createDynamicComponent<T>(contentType: TemplateRef<any> | Type<any> | string | Object, componentType: Type<any>, config: DynamicComponentConfig, services?: any[]): ComponentRef<T>;
