...
function addDependencies() {
    return (tree) => {
        ...
        if (!package_utils_1.hasPackage(tree, '@angular/cdk')) {
            dependencies.push({ type: dependencies_1.NodeDependencyType.Default, version: `${versions_1.cdkVersion}`, name: '@angular/cdk' });
        }
