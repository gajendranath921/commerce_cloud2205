import { AfterContentInit, ChangeDetectorRef, EventEmitter, OnChanges, OnInit, OnDestroy, QueryList, SimpleChanges, TemplateRef } from '@angular/core';
import { ControlValueAccessor } from '@angular/forms';
import { OptionComponent } from './option/option.component';
import { PopperOptions } from 'popper.js';
import { PopoverFillMode } from '../popover/popover-directive/popover.directive';
declare type SelectType = 'noborder' | 'splitborder';
/**
 * Select component intended to mimic the behaviour of the native select element.
 */
export declare class SelectComponent implements OnChanges, AfterContentInit, OnInit, OnDestroy, ControlValueAccessor {
