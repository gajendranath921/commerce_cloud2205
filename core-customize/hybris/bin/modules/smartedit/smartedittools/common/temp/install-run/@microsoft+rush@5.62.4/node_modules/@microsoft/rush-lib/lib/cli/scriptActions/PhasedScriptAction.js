...
const OperationSelector_1 = require("../../logic/operations/OperationSelector");
const Selection_1 = require("../../logic/Selection");
const ShellOperationFactory_1 = require("../../logic/operations/ShellOperationFactory");
...
class PhasedScriptAction extends BaseScriptAction_1.BaseScriptAction {
    ...
    async runAsync() {
        ...
        const operationSelector = new OperationSelector_1.OperationSelector({
            phasesToRun: new Set(this._initialPhases)
        });
        const isWatch = ((_a = this._watchParameter) === null || _a === void 0 ? void 0 : _a.value) || this._alwaysWatch;
    ...
    async _runWatch(options) {
        const { projectSelection: projectsToWatch, operationFactoryOptions, executionManagerOptions, stopwatch, terminal } = options;
        const operationSelector = new OperationSelector_1.OperationSelector({
        ...
        while (true) {
            ...
            const executeOptions = {
                operationSelector,
                projectSelection,
                operationFactoryOptions: Object.assign(Object.assign({}, operationFactoryOptions), { projectChangeAnalyzer: state }),
                executionManagerOptions,
                stopwatch,
    ...
    async _runOnce(options) {
        ...
        const operationFactory = new ShellOperationFactory_1.OperationFactory(operationFactoryOptions);
        const executionManager = new OperationExecutionManager_1.OperationExecutionManager(operationSelector.createOperations({
            projectSelection,
            operationFactory
