import { OnInit, EventEmitter, ElementRef, AfterViewChecked, OnDestroy, ChangeDetectorRef } from '@angular/core';
...
export declare class CalendarYearViewComponent implements AfterViewChecked, OnInit, OnDestroy {
    ...
    private readonly _amountOfColPerRow;
    /** @hidden
    ...
    /** @hidden */
    constructor(eRef: ElementRef, changeDetectorRef: ChangeDetectorRef, calendarService: CalendarService);
    /** @hidden */
