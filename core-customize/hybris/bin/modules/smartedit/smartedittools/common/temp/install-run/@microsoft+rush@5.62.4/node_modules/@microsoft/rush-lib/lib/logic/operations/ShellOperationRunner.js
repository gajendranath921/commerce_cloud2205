...
class ShellOperationRunner {
    constructor(options) {
        ...
        this.isCacheWriteAllowed = false;
        /**
        ...
        try {
            ...
            if (taskIsSuccessful && projectDeps) {
                ...
                const setCacheEntryPromise = this.isCacheWriteAllowed
                    ? (_a = (await this._tryGetProjectBuildCacheAsync(terminal, trackedFiles, context.repoCommandLineConfiguration))) === null || _a === void 0 ? void 0 : _a.trySetCacheEntryAsync(terminal)
                    : undefined;
