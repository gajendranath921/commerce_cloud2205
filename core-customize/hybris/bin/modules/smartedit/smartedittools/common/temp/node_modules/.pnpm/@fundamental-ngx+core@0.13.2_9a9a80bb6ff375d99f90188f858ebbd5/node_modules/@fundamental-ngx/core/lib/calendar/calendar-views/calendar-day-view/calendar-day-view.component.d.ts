...
export declare class CalendarDayViewComponent implements OnInit, OnChanges, OnDestroy {
    ...
    /** @hidden */
    constructor(calendarI18n: CalendarI18n, eRef: ElementRef, changeDetRef: ChangeDetectorRef);
    /**
