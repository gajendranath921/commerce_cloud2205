 ...
 */
export declare class CalendarHeaderComponent implements OnDestroy {
    ...
    constructor(calendarI18nLabels: CalendarI18nLabels, calendarI18n: CalendarI18n, changeDetRef: ChangeDetectorRef);
    /** @hidden */
    ngOnDestroy(): void;
